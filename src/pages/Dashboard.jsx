...
function Dashboard() {
    ...
    return (
        <div>
            <div className="flex ">
                <div
                    className="flex-1 w-1/4 p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700">
                    <SearchBar/>
                    {/* nav products */}
                    <div>
                        <ProductNav/>
                        ...
                        {/*  pagination  */}
                        {
                            page?.total > 1 && (
                                <div className="flex justify-center mt-10">
                                    ...
                                    <div
                                        className="bg-gray-200 hover:bg-gray-300 text-gray-800 font-bold py-2 px-4 border-t border-b border-gray-400">
                                        {page?.current}
                                    </div>
                                    <button
