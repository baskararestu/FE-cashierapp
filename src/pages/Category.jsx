...
const Category = () => {
  ...
  const update = async (value) => {
    await axios.patch(
      `http://localhost:3000/category/${value.id}`,
      { name: value.name },
      {
        headers: {
          'Content-Type': 'application/json',
  ...
  return (
    <div className="page-container py-6">
      <h1 className="text-2xl uppercase font-bold w-fit border-b border-black">
        Category
      </h1>
            ...
            {({ handleSubmit, values, errors }) => (
              <Form action="#" method="post">
                ...
                <div className="flex flex-col gap-y-4">
                  ...
                  <button
                    type="submit"
                    className="bg-orange-400 text-white px-4 py-2 rounded-sm uppercase font-bold"
                  >
                    Save
                  </button>
                </div>
          ...
          <div className="fixed inset-0 flex justify-center items-center">
            <div className="bg-white w-[500px] rounded-sm">
              <div className="flex flex-col gap-y-4 p-4">
                <h3 className="uppercase font-bold w-fit mb-3">
                  Edit Category
                </h3>
                <div className="flex flex-col gap-y-2">
                  <Formik
